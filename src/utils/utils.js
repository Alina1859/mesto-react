...
export {
  formProfile, formAddPlace, nameInput, descriptionInput,
  editBtn, addPlaceBtn, cardsContainerSelector,
  initialCards, validationConfig, profileName,
  profileDescription, profileImg, trashBtn, avatarBtn,
  popupEditAvatar, formEditAvatar };
